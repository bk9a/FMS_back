...
import { Ingreadant } from "../Components/Ingreadant";
...
const CalculatorCal = () => {
  ...
  return (
    <div className="w-full h-screen flex flex-col justify-start items-center  bg-white text-black py-10 px-20 space-y-10">
