...
import { HomeSliderCols } from "./HomeSliderCols";
...
const HomeSlider = () => {
  ...
  const getData = async () => {
    ...
    await axios
      .get(
        `${process.env.REACT_APP_API}/home-slider?page=${pageNum}&limit=${limit}`,
        {
          headers: {
  ...
  return (
    <div className="pt-4 space-y-4">
      <Link className="pl-4 inline-block relative" to="/admin/addslider">
